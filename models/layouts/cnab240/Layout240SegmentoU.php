...
class Layout240SegmentoU extends Layout240Segmento implements ILayoutSegmentoU {
    ...
    public function rules() {
        return parent::rules() + array(
            array('juros_multa_encargos,valor_do_desconto_concedido,valor_do_abatimento_concedido_cancelado,valor_do_iof_recolhido,valor_pago_pelo_sacado,valor_liquido_a_ser_creditado,valor_de_outras_despesas,valor_de_outros_creditos,data_da_ocorrencia,data_da_efetivacao_do_credito,codigo_da_ocorrencia_do_sacado,data_da_ocorrencia_do_sacado,valor_da_ocorrencia_do_sacado,complemento_da_ocorrencia_do_sacado,código_do_banco_correspondente_compens,nosso_numero_banco_correspondente,uso_exclusivo_febraban_cnab_2', 'required'),
            array('juros_multa_encargos', 'numerical', 'min' => 0, 'max' => 999999999999999),
            array('valor_do_desconto_concedido', 'numerical', 'min' => 0, 'max' => 999999999999999),
            array('valor_do_abatimento_concedido_cancelado', 'numerical', 'min' => 0, 'max' => 999999999999999),
            array('valor_do_iof_recolhido', 'numerical', 'min' => 0, 'max' => 999999999999999),
            array('valor_pago_pelo_sacado', 'numerical', 'min' => 0, 'max' => 999999999999999),
            array('valor_pagovalor_liquido_a_ser_creditadopelo_sacado', 'numerical', 'min' => 0, 'max' => 999999999999999),
            array('valor_de_outras_despesas', 'numerical', 'min' => 0, 'max' => 999999999999999),
            array('valor_de_outros_creditos', 'numerical', 'min' => 0, 'max' => 999999999999999),
            array('data_da_ocorrencia', 'date', 'format' => 'ddMMyyyy'),
            array('data_da_efetivacao_do_credito', 'date', 'format' => 'ddMMyyyy'),
            array('codigo_da_ocorrencia_do_sacado', 'length', 'min' => 4, 'max' => 4),
            array('data_da_ocorrencia_do_sacado', 'date', 'format' => 'ddMMyyyy'),
            array('valor_da_ocorrencia_do_sacado', 'numerical', 'min' => 0, 'max' => 999999999999999),
            array('complemento_da_ocorrencia_do_sacado', 'length', 'min' => 30, 'max' => 30),
            array('codigo_do_banco_correspondente_compensacao', 'numerical', 'integerOnly' => true, 'min' => 0, 'max' => 999),
            array('nosso_numero_banco_correspondente', 'numerical', 'integerOnly' => true, 'min' => 0, 'max' => 99999999999999999999),
            array('uso_exclusivo_febraban_cnab_1', 'length', 'min' => 7, 'max' => 7),
        );
    }
